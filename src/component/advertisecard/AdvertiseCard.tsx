    ...
    return <div className="w-full h-auto md:w-4/5 lg:w-2/5 flex flex-col border border-black my-2">
        ...
        <div className="w-full h-auto flex flex-col px-2">
            ...
            <div className="flex flex-row items-center my-2 md:text-lg">
                <img src="/image/Location.svg" alt="icon" />
                <p>آدرس </p>
            </div>
            ...
            <div className=" flex flex-row justify-between items-center text-sm md:text-lg my-2 md:my-4">
                ...
                <div>
                    {data.publishType!= SellAdPublishTypeEnum.Simple?<button className={data.publishType== SellAdPublishTypeEnum.Featured?"bg-featured_ads_tag p-2 rounded ml-1 md:ml-3 text-black":data.publishType== SellAdPublishTypeEnum.Occasion?"bg-featured_ads_tag p-2 rounded ml-1 md:ml-3 text-black":"p-2 rounded ml-1 md:ml-3 text-black"}>{data.publishType== SellAdPublishTypeEnum.Featured?"فوری":data.publishType== SellAdPublishTypeEnum.Occasion?"ویژه":""}</button>:null}
                    <button className="p-3 lg:p-4 text-sm lg:text-lg rounded ml-1 md:ml-3 text-white bg-green_accent">پیامک</button>
                    <button className="p-3 lg:p-4 text-sm lg:text-lg rounded text-white bg-green_accent">تماس</button>
                </div>
            </div>
        </div>
