...
export const LetForCreateDtoPublishTypeEnum = {
    Simple: 'simple',
    Occasion: 'occasion',
    Featured: 'featured'
} as const;

export type LetForCreateDtoPublishTypeEnum = typeof LetForCreateDtoPublishTypeEnum[keyof typeof LetForCreateDtoPublishTypeEnum];
