...
export default function Projects(){
    return <div>
        ...
        <h1 className="font-iransansbold text-xl my-6">لیست پروژه های ساختمانی</h1>
                    <div className="bg-gradient-to-b from-upnblue_gradient to-downnblue_gradient w-full h-20 my-2 md:w-4/5 lg:w-2/5 flex flex-row items-center justify-between px-4 rounded-md">
                        <span className="flex flex-col items-start justify-center text-white text-2xl">
                    <p>شهر</p>
                  </span>
                        <span className="flex flex-row items-center h-8">
                    <span className="bg-upgreen_gradient h-full p-1 rounded ml-2 flex justify-center text-base">همه</span>
